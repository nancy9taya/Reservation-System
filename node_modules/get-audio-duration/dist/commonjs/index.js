...
function getFFprobeWrappedExecution(input) {
    var params = ['-v', 'error', '-select_streams', 'a:0', '-show_format', '-show_streams'];
    if (typeof input === 'string') {
        return execa(ffprobe.path, params.concat([input]));
    }
    if (isStream(input)) {
        return execa(ffprobe.path, params.concat(['-i', 'pipe:0']), {
            reject: false,
            input: input
        });
    }
 ...
 * seconds.
 */
function getAudioDurationInSeconds(input) {
